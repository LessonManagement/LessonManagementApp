    ...
    <div class="container-xl">
        <div class="bread-crumbs mb-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('profesor/{profesor}') }}">Visualizar profesor</a></li>
            </ol>
        </div>
        <div class="card-header">
            <h2 class="page-title">Ver profesor: {{ $profesor->nombre }}</h2>
        </div>
    </div>
</div>
<div class="page-body">
        <div class="container-xl">
            <div class="row d-flex justify-content-evenly ">
                <div class="card mb-5 col-sm-6 col-lg-3">
                    <div class="card-header card-header-black">
                        <h3 class="card-title">Usuario de Séneca</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mb-5 col-sm-6 col-lg-3">
                    <div class="card-header card-header-black">
                        <h3 class="card-title">Apellidos</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="row g-2">
                ...
                <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                    <a href="{{ url('profesor/' . $profesor->id . '/edit') }}" class="btn btn-warning w-100">
