...
@section('main-content')
        ...
        <div class="container-xl">
            <div class="bread-crumbs mb-5">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('profesor/{profesor}/edit') }}">Editar
                            profesor</a>
                    </li>
                </ol>
            </div>
    ...
    <div class="page-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="seneca_username" id="seneca_username"
                                placeholder="Introduce el usuario de séneca..."
                                value="{{ old('seneca_username', $profesor->seneca_username) }}" maxlength="20"
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="nombre" id="nombre"
                                placeholder="Introduce el nombre..." value="{{ old('nombre', $profesor->nombre) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="apellido1" id="apellido1"
                                ...
                                value="{{ old('apellido1', $profesor->apellido1) }}" maxlength="100" minlength="1"
                                required>
                        </div>
                        @error('apellido1')
                            <p style="color: #c62828; font-size: .9rem">{{ $message }}</p>
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="email" id="email"
                                placeholder="Introduce el email..." value="{{ old('email', $profesor->email) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="especialidad" id="especialidad"
                                ...
                                value="{{ old('especialidad', $profesor->especialidad) }}" maxlength="100"
                                minlength="1" required>
                        </div>
                        @error('especialidad')
                            <p style="color: #c62828; font-size: .9rem">{{ $message }}</p>
        ...
        <div class="row g-2">
            ...
            <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                <a href="{{ url('profesor/' . $profesor->id) }}" class="btn btn-warning w-100">
