    ...
    <div class="container-xl">
        <div class="bread-crumbs mb-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('profesor/{profesor}/edit') }}">Editar profesor</a>
                </li>
            </ol>
        </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" name="especialidad" id="especialidad"
                            ...
                            value="{{ old('especialidad', $profesor->especialidad) }}" maxlength="100" minlength="1"
                            required>
                    </div>
                    @error('especialidad')
                    <p style="color: #c62828; font-size: .9rem">{{ $message }}</p>
