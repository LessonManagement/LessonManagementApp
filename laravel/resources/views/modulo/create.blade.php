        ...
        <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                    ...
                    <a class="dropdown-item active" href="{{ url('modulo/create') }}">
                        Añadir modulo
                    </a>
                </div>
            </div>
    ...
    <div class="container-xl">
        <div class="bread-crumbs mb-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ url('modulo/create') }}">Añadir módulo</a></li>
            </ol>
        </div>
        <div class="row g-2">
            <h2 class="page-title">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" class="form-control" name="denominacion" id="denominacion"
                            placeholder="Introduce la denominación..." maxlength="100" minlength="1" required
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <select name="idformacion" id="idformacion" class="form-select" required>
                            ...
                            <option value="{{$formacion->id}}" {{old('idformacion')===$formacion->id ? 'selected' :
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="number" step="1" name="horas" id="horas" class="form-control"
                            placeholder="Introduce el número de horas..." required min="1" value="{{old('horas')}}">
                    </div>
                </div>
                <div class="mb-3">
