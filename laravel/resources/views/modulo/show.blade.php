        ...
        <div class="container-xl">
            <div class="bread-crumbs mb-5">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('modulo/{modulo}') }}">Ver módulo</a></li>
                </ol>
            </div>
            <div class="row g-2">
                <h2 class="page-title">
                    Vista en detalle módulo '{{ $modulo->siglas }}''
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row d-flex justify-content-evenly mb-5">
                ...
                <div class="card mb-5 col-sm-6 col-lg-3">
                    <div class="card-header card-header-black">
                        <h3 class="card-title">Nº Horas</h3>
                    </div>
                    <div class="card-body">
                        {{ $modulo->horas }}
                    </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                    <a href="{{ url('modulo/' . $modulo->id . '/edit') }}" class="btn btn-warning w-100">
