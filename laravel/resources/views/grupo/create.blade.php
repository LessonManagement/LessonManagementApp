            ...
            <form class="card" action="{{ url('grupo') }}" method="post">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="denominacion" id="denominacion"
                                placeholder="Introduce la denominación del grupo..." maxlength="150" minlength="1"
                                required value="{{ old('denominacion') }}">
                        </div>
                        @error('denominacion')
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="number" step="1" name="curso_escolar" id="curso_escolar"
                                class="form-control" placeholder="Introduce el cusro escolar..." required min="1"
                                value="{{ old('curso_escolar') }}">
                        </div>
                        @error('curso_escolar')
                            <p style="color: #c62828; font-size: .9rem">{{ $message }}</p>
                        @enderror
