        ...
        <div class="container-xl">
            ...
            <div class="row g-2 d-flex flex-row justify-content-between">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <a href="{{ url('grupo/create') }}" class="btn btn-primary">
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                    <tr>
                                        <th class="w-1">
                                            ID
                                            <a href="?rpp={{ $rpp }}&orderBy=grupo.id&orderType=asc&q={{ $q }}"
                                            ...
                                            <a
                                                href="?rpp={{ $rpp }}&orderBy=grupo.id&orderType=desc&q={{ $q }}">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <th>
                                            Curso escolar
                                            <a href="?rpp={{ $rpp }}&orderBy=grupo.curso_escolar&orderType=asc&q={{ $q }}"
                                                style="text-decoration: none">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-up" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                            ...
                                            <a
                                                href="?rpp={{ $rpp }}&orderBy=grupo.curso_escolar&orderType=desc&q={{ $q }}">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-down" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                        ...
                                        <th>
                                            Curso
                                            <a href="?rpp={{ $rpp }}&orderBy=grupo.curso&orderType=asc&q={{ $q }}"
                                                style="text-decoration: none">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-up" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                            ...
                                            <a
                                                href="?rpp={{ $rpp }}&orderBy=grupo.curso&orderType=desc&q={{ $q }}">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-down" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                        ...
                                        <th>
                                            Turno
                                            <a href="?rpp={{ $rpp }}&orderBy=grupo.turno&orderType=asc&q={{ $q }}"
                                                style="text-decoration: none">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-up" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                            ...
                                            <a
                                                href="?rpp={{ $rpp }}&orderBy=grupo.turno&orderType=desc&q={{ $q }}">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-arrow-down" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                            ...
                                            <td class="text-end">
                                                <span class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="{{ url('grupo/' . $grupo->id) }}"
                                                        ...
                                                        <button type="button" form="deleteGrupoForm"
                                                            ...
                                                            data-denominacion="{{ $grupo->denominacion }}"
